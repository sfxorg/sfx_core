...
# V25B
#
# POD-mediated Schwarz Transmission
#
# FULL interface
# POD22 interface
# POD16 interface
...
ik_full = 1j * 2.0 * np.pi * freq
k2_full = -(2.0 * np.pi * freq) ** 2
...
def run_case(rank=None):
    ...
    for step in range(NSTEPS):
        ...
        if rank is None:
            ...
            comm += mean_vec.flatten()

        left_if = comm[:W]
        right_if = comm[W:]

        # Schwarz-like exchange
